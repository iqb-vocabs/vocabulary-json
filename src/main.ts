...
function buildFooter(): HTMLElement {
  ...
  footer.innerHTML = `
    <div class="footer-inner">
      <a href="https://www.iqb.hu-berlin.de/" target="_blank" rel="noopener" class="footer-link" aria-label="IQB Homepage">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 9.5 12 3l9 6.5V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Z"/><path d="M9 21V12h6v9"/></svg>
        IQB
      </a>
      <a href="https://github.com/iqb-vocabs/vocabulary-json" target="_blank" rel="noopener" class="footer-link" aria-label="Source code on GitHub">
